...
def load_models():
    ...
    if not os.path.exists("models"):
        # Use mock models directly without warning
        try:
            from models import MockPregnancyModel, MockFetalModel
            model1 = MockPregnancyModel()
            model2 = MockFetalModel()
            scaler = None
            return model1, model2, scaler
        except Exception as e:
            st.error(f"Error loading mock models: {e}")
    ...
    try:
        ...
        # Fallback to mock models so app still runs locally
        try:
            from models import MockPregnancyModel, MockFetalModel
            st.warning(f"Using mock models due to load error: {e}")
            model1 = MockPregnancyModel()
            model2 = MockFetalModel()
            scaler = None
            return model1, model2, scaler
        except Exception as inner_e:
            st.error(f"Error loading models: {e}; Mock fallback failed: {inner_e}")
            return None, None, None
    ...
    **AI-powered maternal and fetal health predictions** for better healthcare outcomes. 
    ...
    with col1:
        ...
        <div class="metric-card">
            ...
            <p><a href="https://www.who.int/publications/i/item/9789240080591" target="_blank">View source ↗</a></p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="metric-card">
            ...
            <p><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC12049423/" target="_blank">View source ↗</a></p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="metric-card">
            ...
            <p><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC11128252/" target="_blank">View source ↗</a></p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div class="metric-card">
            ...
            <p><a href="https://www.nature.com/articles/s41598-025-89905-1#:~:text=To%20date%2C%20the%20most%20effective,%2C%20recall%2C%20and%20specificity21." target="_blank">View source ↗</a></p>
        </div>
        """, unsafe_allow_html=True)
